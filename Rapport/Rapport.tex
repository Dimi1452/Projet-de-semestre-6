...
\begin{document}
   ...
   % \Partenaire{Pas sur qu'il y en ait un}             % Optionnel
    ...
    \include{frontmatter/Abstract}      % Optionnel
    ...
    \newpage                            % Nouvelle page
    \include{frontmatter/Nomenclature}  % Optionnel
    %\include{frontmatter/Glossaire}     % Optionnel
    ...
    \include{main/Ajustage}					% Le contenu principal
    \include{main/maquette1}       
    \include{main/maquette2}
    \include{main/synthese}          
    \include{main/Conclusion}           % La conclusion
    \newpage                            % Nouvelle page
    ...
    \include{annexe/Annexe}             % Ajout des annexes
\end{document}
